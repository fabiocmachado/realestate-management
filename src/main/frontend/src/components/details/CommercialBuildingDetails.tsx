...
import { CommercialBuildingDTO, Seller, Agent,PropertyStatusDescription } from '../../types/models';
import { formatCPF, formatPhoneNumber, formatAddress } from "../../components/shared/shared";

interface Props {
  property: CommercialBuildingDTO;
  seller: Seller;
  agent: Agent;
}

export const CommercialBuildingDetails: React.FC<Props> = ({ property, seller, agent }) => (
  <div className="property-details-container">
      <h3><strong> Prédio comercial - Código: </strong> {property.propertyCode}</h3>
...
export default CommercialBuildingDetails;

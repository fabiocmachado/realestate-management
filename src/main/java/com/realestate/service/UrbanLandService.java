...
public class UrbanLandService {
    ...
    public UrbanLandDTO createUrbanLand(UrbanLandDTO urbanLandDTO) {
        ...
        UrbanLand urbanLand = urbanLandMapper.toEntity(urbanLandDTO);
    ...
    public UrbanLandDTO updateUrbanLand(String propertyCode, UrbanLandDTO urbanLandDTO) {
        ...
        urbanLandMapper.updateEntityFromDTO(urbanLandDTO, existingUrbanLand);
        existingUrbanLand.setSeller(seller);
        existingUrbanLand.setAgent(agent);

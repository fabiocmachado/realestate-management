...
public interface CountryHouseMapper {
    ...
    @Mapping(target = "smoothWireFence", source = "countryHouseDTO.smoothWireFence")
    @Mapping(target = "topography", source = "countryHouseDTO.topography")
    @Mapping(target = "rocks", source = "countryHouseDTO.rocks")
    ...
    @Mapping(target = "orchard", source = "countryHouseDTO.orchard")
    ...
    @Mapping(target = "landingStrip", source = "countryHouseDTO.landingStrip")
